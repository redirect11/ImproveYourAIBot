...
aqt install-qt -O "$QT_PATH" mac desktop "$QT_VERSION" -m qtwebchannel qtwebengine qtpositioning

# Installing tools to execute cross-platform
aqt install-qt -O "$QT_PATH" linux desktop "$QT_VERSION" linux_gcc_64 -m qtwebchannel qtwebengine qtpositioning
